      ...
      <>
        ...
        <ul className="rightbarFriendList">
           ...
           {alluser.map((allusers) => (
            <CloseFriend key={allusers.id} user={allusers} />
          ))}
        </ul>
      </>
    );
      ...
      <>
        ...
        <div className="rightbarInfo">
          ...
          <div className="rightbarInfoItem">
            ...
            <span className="rightbarInfoValue">{user.skillName}</span>
          </div>
          <div className="rightbarInfoItem">
            <span className="rightbarInfoKey"> skill Level:</span>
